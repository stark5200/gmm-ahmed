    ...
    <>
      <section className="pt-30 lg:pt-[120px] pb-20 lg:pb-[90px] overflow-hidden bg-accent flex items-center justify-center">
        <div className="max-w-6xl p-10">
          ...
          <h2 className="mb-8 mt-10 text-4xl font-bold text-dark sm:text-4xl text-center lg:text-left">
            Location
          </h2>
          ...
          <div className="flex flex-wrap items-center justify-between ">    
            <div className="w-full px-4 lg:w-2/3 xl:w-1/2">
              <div className="mt-20 lg:mt-10">
                ...
                <h2 className="mb-10 text-3xl font-bold text-dark sm:text-4xl text-center lg:text-left">
          ...
          <div className="flex flex-wrap items-center justify-between ">
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/5 xl:w-3/4">
              <div className="mt-20 lg:mt-10">
                ...
                <p className="mb-8 text-xl font-bold leading-8 text-body-color text-center lg:text-left">
